...
## Databáze filamentů, a proč mi to připomnělo Printerhive
...
Jenže přesně tady je vidět rozdíl mezi katalogem a reálným provozem. U nás v Printerhive řešíme správu filamentů a cívek přímo v návaznosti na tisk: párování filamentů přes AMS, přehled slotů a zbývajícího množství, spotřebu materiálu během tisku i přesnější odečty do historie a nákladů. Takže jo, podobná databáze dává smysl, ale za mě je zajímavější ve chvíli, kdy se propojí s tím, co tiskárny skutečně dělají.

To je zároveň i slabina toho Fabbaloo projektu. Název slibuje nejen evidenci, ale i profily, a právě sdílené tiskové profily pro konkrétní kombinaci materiálu a tiskárny tomu zatím chybí. Jako inspirace dobré. Jako plnohodnotná správa filamentů pro reálný provoz je to zatím spíš začátek.

[Více informací](https://www.fabbaloo.com/news/a-long-needed-database-for-filament-management)
[Printerhive](https://printerhive.com)
